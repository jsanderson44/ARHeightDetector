...
//  ExampleARKitApp
//
//  Created by Pranav Kasetti on 14/09/2017.
...
public extension SCNNode {
  convenience init(position: SCNVector3) {
    ...
    // BUBBLE-TEXT
    let bubble = SCNText(string: "Person", extrusionDepth: CGFloat(bubbleDepth))
    ...
    material.diffuse.contents = UIImage.init(named: "Person")
